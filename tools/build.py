...
def main():
    ...
    for idx,ch in enumerate(chapters):
        ...
        extra=''
        if (p/'demo.js').exists():
            shutil.copy2(p/'demo.js',OUT/'assets'/f'ch{ch["id"]}.js'); extra=f'<script defer src="/assets/ch{ch["id"]}.js"></script>'
    ...
    for name,title in (('start','Start here'),('about','About the course'),('git','Track your learning with Git')):
