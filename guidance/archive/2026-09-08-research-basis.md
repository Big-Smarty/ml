# Historical record — superseded by the v2 redesign

**Original scope:** Pre-v2 research, curriculum, tooling, and hardware record
**Original record date:** 2026-09-08
**Archived:** 2026-09-09

> This file preserves the earlier course record verbatim below. It does not describe the active v2 authoring contract, assignments, or validation status. Use the active guidance files in the parent directory.
