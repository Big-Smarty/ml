...
- Hinton, Vinyals, and Dean, [Distillation](https://arxiv.org/abs/1503.02531): soft teacher probabilities and temperature. The executable stays at T=1 so its weighted hard-gradient identity exactly matches the reported KL objective; the lesson derives the T>1 caveat without claiming to implement it.
