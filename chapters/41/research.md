...
The course kernel uses original symmetric signed codes −7..7 for int4, rather than copying llama.cpp's Q4_0 encoding. The decoder-level evaluation quantizes an actual Chapter 36 projection, while the optional benchmark separately measures the scalar packed kernel.
